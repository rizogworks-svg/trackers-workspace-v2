...
(async function(){
  ...
  try{
    const res=await fetch(new URL('app-shell.html?v=2.0.0',root),{cache:'no-store'});
  ...
  try{
    await loadScript(new URL('assets/js/storage-guard.js?v=2.0.0',root));
    await loadScript('https://cdn.jsdelivr.net/npm/xlsx@0.18.5/dist/xlsx.full.min.js');
    await loadScript('https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2');
    await loadScript(new URL('assets/js/config.js?v=2.0.0',root));
    await loadScript(new URL('assets/js/cloud.js?v=2.0.0',root));
    await loadScript(new URL('assets/js/pkbon.js?v=2.0.0',root));
    await loadScript(new URL('assets/js/app.js?v=2.0.0',root));
    await loadScript(new URL('assets/js/boot.js?v=2.0.0',root));
    ...
    const pageJs=new URL(`assets/js/pages/${route}.js?v=2.0.0`,root);
